export class SimplexNoise {
  ...
  noise2D(x: number, y: number): number {
    ...
    if (t0 >= 0) {
      ...
      t0 *= t0;
      n0 = t0 * t0 * (SimplexNoise.grad2[gi0][0] * x0 + SimplexNoise.grad2[gi0][1] * y0);
    }
    ...
    if (t1 >= 0) {
      ...
      t1 *= t1;
      n1 = t1 * t1 * (SimplexNoise.grad2[gi1][0] * x1 + SimplexNoise.grad2[gi1][1] * y1);
    }
    ...
    if (t2 >= 0) {
      ...
      t2 *= t2;
      n2 = t2 * t2 * (SimplexNoise.grad2[gi2][0] * x2 + SimplexNoise.grad2[gi2][1] * y2);
    }
